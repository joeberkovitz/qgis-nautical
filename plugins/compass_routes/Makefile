...
SOURCES = \
	__init__.py \
	compass_routes.py compass_routes_dialog.py

PLUGINNAME = compass_routes

PY_FILES = \
	__init__.py \
	compass_routes.py compass_routes_dialog.py

UI_FILES = compass_routes_dialog_base.ui
...
QGISDIR=/Users/joeb/Library/Application Support/QGIS/QGIS3/profiles/default/python/plugins
